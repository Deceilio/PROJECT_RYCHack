...
{
    public class ADVANCE_PursueTargetStateHumanoid : WRLD_STATE
    {
        [Header("COMBAT STANCE STATE")]
        public ADVANCE_CombatStanceStateHumanoid combatStanceState; // Reference to the Combat Stance State script
        private void Awake()
        {
