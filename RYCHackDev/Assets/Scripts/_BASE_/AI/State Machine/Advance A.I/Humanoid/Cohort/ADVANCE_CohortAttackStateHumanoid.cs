...
{
    public class ADVANCE_CohortAttackStateHumanoid : WRLD_STATE
    {
        [Header("ROTATE TOWARDS TARGET STATE")]
        ADVANCE_CohortRotateTowardsTargetStateHumanoid rotateTowardsTargetState; // Reference to the Rotate Towards Target State
        [Header("COMBAT STANCE STATE")]
        ADVANCE_CohortCombatStanceStateHumanoid combatStanceState; // Reference to the Combat Stance State
        [Header("PURSUE TARGET STATE")]
        ADVANCE_CohortPursueTargetStateHumanoid pursueTargetState; // Reference to the Pursue Target State
        ...
        private void Awake()
        {
            rotateTowardsTargetState = GetComponent<ADVANCE_CohortRotateTowardsTargetStateHumanoid>();
