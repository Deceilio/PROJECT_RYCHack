...
{
    public class ADVANCE_RotateTowardsTargetStateHumanoid : WRLD_STATE
    {
        public ADVANCE_CombatStanceStateHumanoid combatStanceState; // Reference to the Combat Stance State Huamnoid Script
        private void Awake()
        {
