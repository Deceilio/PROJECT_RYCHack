...
{
    public class ADVANCE_CohortCombatStanceStateHumanoid : WRLD_STATE
    {
        [Header("FOLLOW STATE")]
        ADVANCE_CohortFollowStateHumanoid followState; // Reference to the Follow State script
        [Header("ATTACK STATE")]
        ADVANCE_CohortAttackStateHumanoid attackState; // Reference to the Attack State script
        ...
        {
            attackState = GetComponent<ADVANCE_CohortAttackStateHumanoid>();
        ...
        public override WRLD_STATE Tick(AICharacterManager aiCharacter)
        {
            ...
            // BELOW CODE: If A.I is too far away from cohort, we return it
