...
{
    public class UI_GamepadManager : MonoBehaviour
    {
        // Resources
        public UI_MainMenuManager defaultPanelManager;
        public List<UI_MainMenuManager> panelManagers = new List<UI_MainMenuManager>();
