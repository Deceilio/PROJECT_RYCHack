...
{
    public class UI_QualityManager : MonoBehaviour
    {
        // Audio
        public AudioMixer mixer; // Reference to the audio mixr
        public UI_SliderManager masterSlider; // Master slider for the audio
        public UI_SliderManager musicSlider; // Music slider for the audio
        public UI_SliderManager sfxSlider; // SFX Slider for the audio

        // Resolution
        public TMP_Dropdown defaultDropdown; // Default dropdown for the resolution
        public UI_DropdownManager customDropdown; // Dropdown manager for custom dropdown
        public DynamicRes clickEvent; // Click event for the dynamic resolution

        // Settings
        public bool preferCustomDropdown = false; // Checks if prefer custom dropdown or not
        public bool isMobile = false; // Checks if it's mobile game or not
