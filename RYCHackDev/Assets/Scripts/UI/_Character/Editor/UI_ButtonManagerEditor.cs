...
namespace Deceilio.Psychain
{
    ...
    [CustomEditor(typeof(UI_ButtonManager))]
    public class UI_ButtonManagerEditor : Editor
    {
        private UI_ButtonManager bTarget; // Reference to the button target
        private int currentTab; // Reference to the current tab of the button

        private void OnEnable()
        {
            bTarget = (UI_ButtonManager)target;
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (EditorGUIUtility.isProSkin == true)
                customSkin = (GUISkin)Resources.Load("Editor\\Psychain Skin Dark");
            else
                customSkin = (GUISkin)Resources.Load("Editor\\Psychain Skin Light");
